...
const STORAGE_KEY = "clipgenius_history_v1";
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const chat = ai.chats.create({
        model: "gemini-3.1-pro-preview",
        config: {
          systemInstruction: "You are ClipGenius AI, a helpful assistant integrated into a clipboard manager. You can help users analyze their captures, write code, or answer general questions. Use Google Search or Maps grounding when needed.",
      ...
      <div className="flex flex-col lg:flex-row h-screen overflow-hidden">
        ...
        <aside className="w-full lg:w-[45%] h-full border-r border-[#141414]/10 bg-white flex flex-col relative">
          ...
          <div className="flex-1 p-8 md:p-12 flex flex-col">
            {!user ? (
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8 border-2 border-dashed border-[#141414]/10 rounded-3xl bg-[#F9F9F7]">
                <UserIcon className="w-12 h-12 opacity-10 mb-4" />
                <h3 className="text-xl font-bold uppercase tracking-widest mb-2">Authentication Required</h3>
                <p className="text-[10px] font-mono opacity-40 uppercase tracking-[0.2em] mb-8">Login to start capturing</p>
                <button 
                  onClick={handleLogin}
                  className="px-8 py-4 bg-[#141414] text-white text-xs font-mono uppercase tracking-widest rounded-full hover:bg-[#333] transition-all shadow-lg"
                >
                  Sign In to Continue
                </button>
              </div>
                ...
                filteredItems.map((item) => (
                  ...
                  >
                    ...
                    <div className={cn(
                      ...
                      {/* Preview Column */}
                      <div className="w-full md:w-64 aspect-square md:aspect-auto md:h-64 bg-white border border-[#141414]/5 rounded-2xl overflow-hidden relative shadow-sm group-hover:shadow-xl transition-all duration-500">
                        {item.type === "image" ? (
                          <img 
                            src={item.content} 
                            alt="Preview" 
                          ...
                          <div className="w-full h-full flex flex-col items-center justify-center p-8 bg-[#F9F9F7]">
                            {item.type === "url" ? (
                        ...
                        <div className="absolute inset-0 bg-[#141414]/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                          <button 
                      ...
                      <div className="flex-1 flex flex-col justify-center py-2">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-2xl font-bold uppercase tracking-tighter truncate leading-none">
                              {item.isAnalyzing ? (
          ...
          >
            ...
            >
              <div className="p-6 border-b border-[#141414]/5 flex items-center justify-between bg-[#F9F9F7]">
                ...
                <button onClick={() => setIsChatOpen(false)} className="p-2 hover:bg-[#141414]/5 rounded-full transition-colors">
            ...
            >
              <div className="p-6 border-b border-[#141414]/5 flex items-center justify-between bg-[#F9F9F7]">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-bold uppercase tracking-widest text-sm">Image Generator</h3>
                </div>
                <button onClick={() => setIsImageGenOpen(false)} className="p-2 hover:bg-[#141414]/5 rounded-full transition-colors">
                  <XCircle className="w-5 h-5 opacity-30" />
                </button>
              </div>
              ...
              <div className="p-8 space-y-8">
                <div className="space-y-4">
                  <label className="text-[10px] font-mono uppercase tracking-widest opacity-40">Describe your image</label>
                  <textarea 
                    value={imagePrompt}
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-2">
                    <label className="text-[10px] font-mono uppercase tracking-widest opacity-40">Resolution</label>
                    <div className="flex gap-2">
                      {["1K", "2K", "4K"].map((size) => (
                        <button 
                          key={size}
